...
This list is what we set out to create! We've achieved our goal. Now that we've solved this problem in a specific case, we can begin to generalize it to a function. Or, rather, a set of functions!
