...
After we build each function, we can test that it works with both our TIPI dataset and the `iris` dataset to ensure it can handle different data.
...
TIPI_item1 %>% 
  ggplot() +
  geom_density(aes(x = Item1, color = Data, fill = Data), alpha = .5) +
  labs(x = "TIPI Item 1", y = "Density") +
